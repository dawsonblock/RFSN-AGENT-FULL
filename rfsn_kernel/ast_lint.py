"""AST-based Python code linter.

Analyzes function bodies for basic code quality patterns:
- Unreachable code after return/raise
- Unconditional infinite loops (while True without break)

This is a lightweight static analysis tool using Python's ast module,
not symbolic execution or constraint solving.
"""
...
class AstIssue:
    """A single issue found by AST linting."""
...
SymbolicIssue = AstIssue


def _check_unreachable(tree: ast.Module, filename: str) -> List[AstIssue]:
...
def _check_infinite_loops(tree: ast.Module, filename: str) -> List[AstIssue]:
...
def check_file(filepath: str) -> List[AstIssue]:
    """Run all AST lint checks on a Python file.
    ...
    try:
        ...
        return [AstIssue(filepath, 0, "parse_error", str(e))]
...
def check_directory(
    ...
    """Run AST lint checks on all .py files in a directory tree."""
